...
import { Uint128, Binary, Expiration } from "./AstroportXastroToken.types";
export interface AstroportXastroTokenMessage {
...
export declare class AstroportXastroTokenMessageComposer implements AstroportXastroTokenMessage {
    sender: string;
    contractAddress: string;

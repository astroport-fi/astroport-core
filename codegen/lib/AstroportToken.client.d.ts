...
import { Uint128, Binary, MinterResponse, Expiration, AllAccountsResponse, AllAllowancesResponse, AllSpenderAllowancesResponse, AllowanceResponse, BalanceResponse, DownloadLogoResponse, MarketingInfoResponse, TokenInfoResponse } from "./AstroportToken.types";
export interface AstroportTokenReadOnlyInterface {
...
export declare class AstroportTokenQueryClient implements AstroportTokenReadOnlyInterface {
...
export interface AstroportTokenInterface extends AstroportTokenReadOnlyInterface {
    contractAddress: string;
    sender: string;
...
export declare class AstroportTokenClient extends AstroportTokenQueryClient implements AstroportTokenInterface {

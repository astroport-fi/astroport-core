...
exports.AstroportTokenClient = exports.AstroportTokenQueryClient = void 0;
var AstroportTokenQueryClient = /** @class */ (function () {
    function AstroportTokenQueryClient(client, contractAddress) {
        var _this = this;
    ...
    return AstroportTokenQueryClient;
}());
exports.AstroportTokenQueryClient = AstroportTokenQueryClient;
var AstroportTokenClient = /** @class */ (function (_super) {
    __extends(AstroportTokenClient, _super);
    function AstroportTokenClient(client, sender, contractAddress) {
    ...
    return AstroportTokenClient;
}(AstroportTokenQueryClient));
exports.AstroportTokenClient = AstroportTokenClient;

...
exports.AstroportPairClient = exports.AstroportPairQueryClient = void 0;
var AstroportPairQueryClient = /** @class */ (function () {
    function AstroportPairQueryClient(client, contractAddress) {
        var _this = this;
    ...
    return AstroportPairQueryClient;
}());
exports.AstroportPairQueryClient = AstroportPairQueryClient;
var AstroportPairClient = /** @class */ (function (_super) {
    __extends(AstroportPairClient, _super);
    function AstroportPairClient(client, sender, contractAddress) {
    ...
    return AstroportPairClient;
}(AstroportPairQueryClient));
exports.AstroportPairClient = AstroportPairClient;

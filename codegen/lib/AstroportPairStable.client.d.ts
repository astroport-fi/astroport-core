...
import { AssetInfo, Binary, Uint128, Decimal, Asset, ConfigResponse, CumulativePricesResponse, PairInfo, PoolResponse, ReverseSimulationResponse, ArrayOfAsset, SimulationResponse } from "./AstroportPairStable.types";
export interface AstroportPairStableReadOnlyInterface {
...
export declare class AstroportPairStableQueryClient implements AstroportPairStableReadOnlyInterface {
...
export interface AstroportPairStableInterface extends AstroportPairStableReadOnlyInterface {
    contractAddress: string;
    sender: string;
...
export declare class AstroportPairStableClient extends AstroportPairStableQueryClient implements AstroportPairStableInterface {

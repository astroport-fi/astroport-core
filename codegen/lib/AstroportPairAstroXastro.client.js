...
exports.AstroportPairAstroXastroClient = exports.AstroportPairAstroXastroQueryClient = void 0;
var AstroportPairAstroXastroQueryClient = /** @class */ (function () {
    function AstroportPairAstroXastroQueryClient(client, contractAddress) {
        var _this = this;
    ...
    return AstroportPairAstroXastroQueryClient;
}());
exports.AstroportPairAstroXastroQueryClient = AstroportPairAstroXastroQueryClient;
var AstroportPairAstroXastroClient = /** @class */ (function (_super) {
    __extends(AstroportPairAstroXastroClient, _super);
    function AstroportPairAstroXastroClient(client, sender, contractAddress) {
        ...
        _this.assertAndSend = function (_a, fee, memo, funds) {
        ...
        _this.assertAndSend = _this.assertAndSend.bind(_this);
        return _this;
    }
    return AstroportPairAstroXastroClient;
}(AstroportPairAstroXastroQueryClient));
exports.AstroportPairAstroXastroClient = AstroportPairAstroXastroClient;

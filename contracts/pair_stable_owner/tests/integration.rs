...
use astroport_pair_stable_owner::math::{MAX_AMP, MAX_AMP_CHANGE, MIN_AMP_CHANGING_TIME};
use cosmwasm_std::{
...
fn store_pair_code(app: &mut App) -> u64 {
    let pair_contract = Box::new(
        ContractWrapper::new_with_empty(
            astroport_pair_stable_owner::contract::execute,
            astroport_pair_stable_owner::contract::instantiate,
            astroport_pair_stable_owner::contract::query,
        )
        .with_reply_empty(astroport_pair_stable_owner::contract::reply),
    );

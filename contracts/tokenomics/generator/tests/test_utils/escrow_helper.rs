...
impl EscrowHelper {
    ...
    pub fn mint_xastro(&self, router: &mut TestApp, to: &str, amount: u64) {
    ...
    pub fn check_xastro_balance(&self, router: &mut TestApp, user: &str, amount: u64) {
        let amount = amount * MULTIPLIER;
    ...
    pub fn withdraw(&self, router: &mut TestApp, user: &str) -> Result<AppResponse> {
        router.execute_contract(
            Addr::unchecked(user),
            self.escrow_instance.clone(),
            &ExecuteMsg::Withdraw {},
    ...
    pub fn query_user_vp(&self, router: &mut TestApp, user: &str) -> StdResult<f32> {
        router
            .wrap()
            .query_wasm_smart(
                self.escrow_instance.clone(),
    ...
    pub fn query_user_vp_at(&self, router: &mut TestApp, user: &str, time: u64) -> StdResult<f32> {
        router
            .wrap()
            .query_wasm_smart(
                self.escrow_instance.clone(),
    ...
    pub fn query_total_vp(&self, router: &mut TestApp) -> StdResult<f32> {
        router
            .wrap()
    ...
    pub fn query_total_vp_at(&self, router: &mut TestApp, time: u64) -> StdResult<f32> {
        router
            .wrap()
            .query_wasm_smart(
                self.escrow_instance.clone(),
    ...
    pub fn query_total_vp_at_period(&self, router: &mut TestApp, period: u64) -> StdResult<f32> {
        router
            .wrap()
            .query_wasm_smart(
                self.escrow_instance.clone(),
    ...
    pub fn query_lock_info(&self, router: &mut TestApp, user: &str) -> StdResult<LockInfoResponse> {

...
pub fn instantiate(
    ...
    let config = Config {
        generator_contract_addr: user_input_to_addr(deps.api, &msg.generator_contract_addr)?,
        pair_addr: user_input_to_addr(deps.api, &msg.pair_addr)?,
        lp_token_addr: user_input_to_addr(deps.api, &msg.lp_token_addr)?,
        reward_contract_addr: user_input_to_addr(deps.api, &msg.reward_contract_addr)?,
        reward_token_addr: user_input_to_addr(deps.api, &msg.reward_token_addr)?,
    };

...
fn compute_swap(
    ...
    let return_amount =
        Uint128(calc_amount(offer_pool.u128(), ask_pool.u128(), offer_amount.u128(), AMP).unwrap());
...
fn compute_offer_amount(
    ...
    let offer_amount =
        Uint128(calc_amount(ask_pool.u128(), offer_pool.u128(), ask_amount.u128(), AMP).unwrap());

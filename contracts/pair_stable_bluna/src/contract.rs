...
use astroport::pair::{
    ConfigResponse, CumulativePricesResponse, Cw20HookMsg, InstantiateMsg, PoolResponse, QueryMsg,
    ReverseSimulationResponse, SimulationResponse, DEFAULT_SLIPPAGE, MAX_ALLOWED_SLIPPAGE,
    TWAP_PRECISION,
};
use astroport::pair_stable_bluna::{
    ExecuteMsg, MigrateMsg, StablePoolConfig, StablePoolParams, StablePoolUpdateParams,
};
...
pub fn provide_liquidity(
    ...
    if !total_share.is_zero() {
        let old_user_share = astroport::querier::query_token_balance(
            &deps.querier,
...
pub fn handle_rewards(
    ...
    response.messages.push(SubMsg::new(WasmMsg::Execute {
        ...
        msg: to_binary(&ExecuteMsg::Execute {
            ...
            .into_msg(&deps.querier, user.clone())?],
        })?,
    }));

...
/// ```
/// # use ap_factory::PairType::{Custom, Stable, Xyk};
/// Xyk {};
/// Stable {};
...
pub fn query_pairs_info(
    ...
    querier.query_wasm_smart(factory_contract, &QueryMsg::Pairs { start_after, limit })
}
...
pub fn query_factory_config(
    ...
    querier.query_wasm_smart(factory_contract, &QueryMsg::Config {})
}
...
pub fn query_fee_info(
    ...
    let res: FeeInfoResponse =
        querier.query_wasm_smart(factory_contract, &QueryMsg::FeeInfo { pair_type })?;

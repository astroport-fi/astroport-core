...
Pair bonded template gives a trait that allows implementation pairs with bonded assets(e.g. ASTRO-xASTRO, MARS-xMARS, and other tokens that are correlated but have an increasing exchange rate compared to the other token).
Use [Pair ASTRO-xASTRO](/contracts/pair_astro_xastro/src/lib.rs) as example of template implementation.
